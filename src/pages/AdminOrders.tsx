    ...
    if (order?.customer_email) {
      try {
        await supabase.functions.invoke("send-order-email", {
          body: { type: "status_update", email: order.customer_email, customerName: order.customer_name, orderId, status: newStatus, totalAmount: order.total_amount, trackingId: order.tracking_id || trackingInputs[orderId] || null },
        });
