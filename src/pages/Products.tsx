      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="max-w-4xl mx-auto mb-8 flex gap-3">
          ...
          <motion.button
            ...
            className="lg:hidden flex items-center gap-2 px-4 py-3.5 bg-background border border-border rounded-2xl text-foreground"
          >
          ...
          {showMobileFilters && (
            <>
              ...
              <motion.div
                ...
                className="fixed top-0 right-0 bottom-0 w-[85%] max-w-sm bg-background z-50 overflow-y-auto shadow-2xl"
              >
                <ProductFilterSidebar
                  categories={categories.filter((c) => !c.parent_id)}
                  allTags={allTags}
