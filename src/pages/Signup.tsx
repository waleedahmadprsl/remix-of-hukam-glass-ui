    ...
    <div className="min-h-screen flex items-center justify-center bg-background px-4">
      ...
      >
        <div className="text-center">
          ...
          <p className="text-muted-foreground mt-1">Join HUKAM for a better shopping experience</p>
        </div>
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="password" type={showPw ? "text" : "password"} placeholder="Min 6 characters" value={password} onChange={(e) => setPassword(e.target.value)} className="pl-10 pr-10" required />
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-muted-foreground" />
                <Input id="confirmPw" type={showPw ? "text" : "password"} placeholder="Repeat password" value={confirmPw} onChange={(e) => setConfirmPw(e.target.value)} className="pl-10" required />
              </div>
            </div>
