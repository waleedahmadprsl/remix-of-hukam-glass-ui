      ...
      <div className="container mx-auto px-4">
        ...
        <div className="relative group/scroll">
          ...
          <div
            ...
            className={`absolute left-0 top-0 bottom-0 w-10 z-10 bg-gradient-to-r from-background/80 to-transparent pointer-events-auto transition-opacity duration-300 ${
          ...
          <div
            ...
            onMouseLeave={stopAutoScroll}
            className={`absolute right-0 top-0 bottom-0 w-10 z-10 bg-gradient-to-l from-background/80 to-transparent pointer-events-auto transition-opacity duration-300 ${
