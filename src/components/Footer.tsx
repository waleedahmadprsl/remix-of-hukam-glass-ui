        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 flex-wrap">
              <a href={`https://web.whatsapp.com/send?phone=${settings.whatsappNumber}`} target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="w-8 h-8 rounded-full flex items-center justify-center bg-background border border-border/30 text-muted-foreground hover:text-[#25D366] hover:border-[#25D366]/40 transition-all">
