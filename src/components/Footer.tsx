        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="text-xs text-muted-foreground leading-relaxed">
              Order Nahi, HUK<span className="text-primary">A</span>M Kijiye.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-1.5">
              {quickLinks.map((link) => (
                <li key={link.label}>
                  <button onClick={() => navigate(link.path)} className="text-xs text-muted-foreground hover:text-foreground transition-colors cursor-pointer text-left">
                    {link.label}
                  </button>
                </li>
              ))}
          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="flex items-center gap-2 flex-wrap">
                <a href="https://wa.me/923277786498" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="w-8 h-8 rounded-full flex items-center justify-center bg-background border border-border/30 text-muted-foreground hover:text-[#25D366] hover:border-[#25D366]/40 transition-all">
                ...
                <a href="https://tiktok.com/@hukam.pk" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="w-8 h-8 rounded-full flex items-center justify-center bg-background border border-border/30 text-muted-foreground hover:text-foreground hover:border-foreground/40 transition-all">
                  <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4"><path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.88-2.88 2.89 2.89 0 012.88-2.88c.28 0 .56.04.82.11v-3.5a6.37 6.37 0 00-.82-.05A6.34 6.34 0 003.15 15.2a6.34 6.34 0 006.34 6.34 6.34 6.34 0 006.34-6.34V8.92a8.27 8.27 0 004.76 1.5V7a4.83 4.83 0 01-1-.31z" /></svg>
                </a>
            ...
            {/* Payment Methods */}
            <div>
              <h4 className="font-semibold text-foreground mb-3 text-xs uppercase tracking-wider">We Accept</h4>
              <div className="flex items-center gap-2 flex-wrap">
                <span className="px-2.5 py-1 rounded-md bg-background border border-border/30 text-[10px] font-bold text-foreground">💵 COD</span>
                <span className="px-2.5 py-1 rounded-md bg-background border border-border/30 text-[10px] font-bold text-foreground">📱 JazzCash</span>
                <span className="px-2.5 py-1 rounded-md bg-background border border-border/30 text-[10px] font-bold text-foreground">📱 Easypaisa</span>
                <span className="px-2.5 py-1 rounded-md bg-background border border-border/30 text-[10px] font-bold text-foreground">🏦 Bank Transfer</span>
              </div>
            </div>
          </div>
        </div>
