      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 mb-8">
          ...
          <div className="flex flex-col gap-2">
            <img src={logoIcon} alt={settings.storeName} className="h-8 w-fit" />
            <p className="text-xs text-muted-foreground leading-relaxed">
              {settings.tagline.includes("HUKAM") ? (
          ...
          <div>
            ...
            <div className="flex items-center gap-2 flex-wrap">
              <a href={`https://wa.me/${settings.whatsappNumber}`} target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="w-8 h-8 rounded-full flex items-center justify-center bg-background border border-border/30 text-muted-foreground hover:text-[#25D366] hover:border-[#25D366]/40 transition-all">
        ...
        <div className="border-t border-border/20 pt-5 pb-3">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 mb-4">
            {[
              ...
              { label: `60-Min Delivery in ${settings.city}`, icon: "⚡" },
