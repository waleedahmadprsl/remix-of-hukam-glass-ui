        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 flex-wrap">
                <span className="px-2.5 py-1 bg-background border border-border/30 rounded-md text-[10px] font-bold text-foreground">💵 COD</span>
                <span className="px-2.5 py-1 bg-background border border-border/30 rounded-md text-[10px] font-bold text-foreground">📱 JazzCash</span>
                <span className="px-2.5 py-1 bg-background border border-border/30 rounded-md text-[10px] font-bold text-foreground">📱 Easypaisa</span>
                <span className="px-2.5 py-1 bg-background border border-border/30 rounded-md text-[10px] font-bold text-foreground">🏦 Bank Transfer</span>
              </div>
            </div>
          </div>
        </div>
