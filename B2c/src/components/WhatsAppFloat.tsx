...
const WhatsAppFloat = () => (
  ...
  >
    <svg viewBox="0 0 24 24" fill="currentColor" className="w-7 h-7">
      ...
      <path d="M12 2C6.477 2 2 6.477 2 12c0 1.89.525 3.66 1.438 5.168L2 22l4.832-1.438A9.955 9.955 0 0012 22c5.523 0 10-4.477 10-10S17.523 2 12 2zm0 18a8 8 0 01-4.243-1.212l-.257-.154-2.871.853.853-2.871-.154-.257A8 8 0 1112 20z" />
    </svg>
  </motion.a>
);
